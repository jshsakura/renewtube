...
export const EN: Record<string, string> = {
  "이 곡은 재생할 수 없어 다음 곡으로 넘어갑니다": "This track will not play, so the next one starts",
  "둘러보기": "Browse",
  "검색": "Search",
  "홈": "Home",
  "구독": "Subscriptions",
  ...
  "화면 보기": "Show video",
  "화면 속 화면으로 전환하지 못했습니다. 잠시 후 다시 눌러 주세요.": "Could not enter Picture in Picture. Try again in a moment.",
  "가사": "Lyrics",
